...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('transaction')->name('transaction.')->group(function () {
        ...
        Route::prefix('approval')->name('approval.')->group(function () {
            Route::get('/', [ApprovalPermintaanController::class, 'index'])->name('index')->middleware(['role:admin,kepala_unit,kasubbag_tu,kepala_pusat,admin_gudang,admin_gudang_aset,admin_gudang_persediaan,admin_gudang_farmasi,perencanaan,pengadaan,keuangan']);
            Route::get('/{id}', [ApprovalPermintaanController::class, 'show'])->name('show')->middleware(['role:admin,kepala_unit,kasubbag_tu,kepala_pusat,admin_gudang,admin_gudang_aset,admin_gudang_persediaan,admin_gudang_farmasi,perencanaan,pengadaan,keuangan']);

            // Action khusus untuk Kepala Unit (mengetahui)
            Route::post('/{id}/mengetahui', [ApprovalPermintaanController::class, 'mengetahui'])->name('mengetahui')->middleware(['role:admin,kepala_unit']);

            // Action khusus untuk Kasubbag TU (verifikasi/kembalikan)
            Route::post('/{id}/verifikasi', [ApprovalPermintaanController::class, 'verifikasi'])->name('verifikasi')->middleware(['role:admin,kasubbag_tu']);
            Route::post('/{id}/kembalikan', [ApprovalPermintaanController::class, 'kembalikan'])->name('kembalikan')->middleware(['role:admin,kasubbag_tu']);

            // Action untuk Kepala Pusat (approve/reject)
            Route::post('/{id}/approve', [ApprovalPermintaanController::class, 'approve'])->name('approve')->middleware(['role:admin,kepala_pusat']);
            Route::post('/{id}/reject', [ApprovalPermintaanController::class, 'reject'])->name('reject')->middleware(['role:admin,kepala_pusat']);

            // Action untuk disposisi - Admin Gudang/Pengurus Barang melakukan disposisi ke admin gudang kategori
            Route::post('/{id}/disposisi', [ApprovalPermintaanController::class, 'disposisi'])->name('disposisi')->middleware(['role:admin,admin_gudang']);
        });
        ...
        Route::prefix('draft-distribusi')->name('draft-distribusi.')->middleware(['role:admin,admin_gudang,admin_gudang_aset,admin_gudang_persediaan,admin_gudang_farmasi,kepala_unit,kepala_pusat,kasubbag_tu'])->group(function () {
            ...
            Route::get('/create/{approvalLogId}', [DraftDistribusiController::class, 'create'])->name('create')->middleware(['role:admin,admin_gudang,admin_gudang_aset,admin_gudang_persediaan,admin_gudang_farmasi']);
            Route::post('/', [DraftDistribusiController::class, 'store'])->name('store')->middleware(['role:admin,admin_gudang,admin_gudang_aset,admin_gudang_persediaan,admin_gudang_farmasi']);
        ...
        Route::post('penerimaan-barang/{penerimaan_barang}/verify', [PenerimaanBarangController::class, 'verify'])
            ...
            ->middleware(['role:admin,admin_gudang,admin_gudang_aset,admin_gudang_persediaan,admin_gudang_farmasi,admin_gudang_unit,pegawai,kepala_unit']);
        Route::resource('penerimaan-barang', PenerimaanBarangController::class)->except(['create', 'store'])->middleware(['role:admin,admin_gudang,admin_gudang_aset,admin_gudang_persediaan,admin_gudang_farmasi,admin_gudang_unit,pegawai,kepala_unit']);
