...
<div class="bg-white shadow-sm rounded-lg border border-gray-200">
    <div class="px-6 py-5 border-b border-gray-200">
        <h2 class="text-xl font-semibold text-gray-900">Tambah Sub Kegiatan</h2>
    </div>
    
    <form action="{{ route('master.sub-kegiatan.store') }}" method="POST" class="p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" id="nama_sub_kegiatan" name="nama_sub_kegiatan" required value="{{ old('nama_sub_kegiatan') }}" placeholder="Masukkan nama sub kegiatan" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('nama_sub_kegiatan') border-red-500 @enderror">
