...
@section('content')
<x-form.card-form title="Edit Kegiatan" icon="pencil-square" size="col-xl-10">
    <form action="{{ route('master.kegiatankegitan.update', $kegiatankegitan->id_kegiatankegitan) }}" method="POST" class="row g-4">
        @csrf
        @method('PUT')
        ...
        <div class="col-md-6">
            ...
            >
                ...
                @foreach($programs ?? [] as $program)
                    <option value="{{ $program->id_program }}" {{ old('id_program', $kegiatankegitan->id_program) == $program->id_program ? 'selected' : '' }}>
        ...
        <div class="col-md-6">
            ...
            >
                <option value="1" {{ old('is_active', $kegiatankegitan->is_active) == '1' ? 'selected' : '' }}>Aktif</option>
                <option value="0" {{ old('is_active', $kegiatankegitan->is_active) == '0' ? 'selected' : '' }}>Nonaktif</option>
            </select>
            @error('is_active')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        ...
        <div class="col-md-4">
            ...
            <input 
                ...
                value="{{ old('kode_kegiatankegitan', $kegiatankegitan->kode_kegiatankegitan) }}"
        ...
        <div class="col-md-8">
            ...
            <input 
                ...
                value="{{ old('nama_kegiatankegitan', $kegiatankegitan->nama_kegiatankegitan) }}"
        ...
        <div class="col-12">
            ...
            >{{ old('keterangan', $kegiatankegitan->keterangan) }}</textarea>
            @error('keterangan')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
