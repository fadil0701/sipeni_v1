...
<div class="bg-white shadow-sm rounded-lg border border-gray-200">
    <div class="px-6 py-5 border-b border-gray-200">
        <h2 class="text-xl font-semibold text-gray-900">Tambah Gudang</h2>
    </div>
    
    <form action="{{ route('master.gudang.store') }}" method="POST" class="p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div>
                ...
                >
                    ...
                    <option value="PUSAT" {{ old('jenis_gudang') == 'PUSAT' ? 'selected' : '' }}>Pusat</option>
                    <option value="UNIT" {{ old('jenis_gudang') == 'UNIT' ? 'selected' : '' }}>Unit</option>
                </select>
                @error('jenis_gudang')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div id="kategori_gudang_field" style="display: none;">
                ...
                >
                    ...
                    <option value="ASET" {{ old('kategori_gudang') == 'ASET' ? 'selected' : '' }}>ASET</option>
                    <option value="PERSEDIAAN" {{ old('kategori_gudang') == 'PERSEDIAAN' ? 'selected' : '' }}>PERSEDIAAN</option>
                    <option value="FARMASI" {{ old('kategori_gudang') == 'FARMASI' ? 'selected' : '' }}>FARMASI</option>
                </select>
