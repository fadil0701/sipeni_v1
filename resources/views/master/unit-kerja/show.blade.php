...
<div class="bg-white shadow-sm rounded-lg border border-gray-200">
    <div class="px-6 py-5 border-b border-gray-200 flex justify-between items-center">
        <h2 class="text-xl font-semibold text-gray-900">Detail Unit Kerja</h2>
        <a 
    ...
    <div class="p-6">
        <dl class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2">
            <div>
                <dt class="text-sm font-medium text-gray-500 mb-1">Kode Unit Kerja</dt>
                <dd class="text-sm font-semibold text-gray-900">{{ $unitKerja->kode_unit_kerja }}</dd>
            </div>
            <div>
