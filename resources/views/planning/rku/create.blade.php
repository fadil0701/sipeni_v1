                ...
                <div>
                    ...
                    >
                        ...
                        @foreach ($unitKerjaList ?? [] as $uk)
                            <option value="{{ $uk->id_unit_kerja }}" {{ old('id_unit_kerja', $selectedUnit) == $uk->id_unit_kerja ? 'selected' : '' }}>
                                {{ $uk->nama_unit_kerja }}
                            </option>
                        @endforeach
                    </select>
                            ...
                            @if (old('details'))
                                @foreach (old('details') as $index => $detail)
                                    <tr class="detail-row">
                                        ...
                                        <td class="px-3 py-2">
                                            <input type="text" name="details[{{ $index }}][nama_item]" value="{{ $detail['nama_item'] ?? ($detail['nama_barang'] ?? '') }}" class="block w-full rounded-md border border-gray-300 px-3 py-2 text-sm" placeholder="Contoh: Dental unit / Laptop operasional" required>
                                        </td>
                                        <td class="px-3 py-2">
                                            <input
                                                type="number"
