...
<div class="sipeni-flash-stack mb-4 space-y-2" data-sipeni-flash-stack>
    ...
    @if (session('warning'))
        <div class="alert-box alert-warning flex items-start justify-between gap-3" role="alert">
            <div class="flex items-start gap-2">
    ...
    @if (session('info'))
        <div class="alert-box alert-info flex items-start justify-between gap-3" role="status">
            <div class="flex items-start gap-2">
                <svg class="mt-0.5 h-5 w-5 shrink-0 text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    @if (session('status'))
        <div class="alert-box flex items-start justify-between gap-3 border-gray-200 bg-gray-50 text-gray-800" role="status">
