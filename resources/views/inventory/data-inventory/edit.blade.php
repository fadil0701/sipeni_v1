            ...
            <div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="hidden" id="id_gudang_hidden" name="id_gudang" value="{{ old('id_gudang', $dataInventory->id_gudang) }}">
                        <select id="id_gudang" disabled class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('id_gudang') border-red-500 @enderror">
                            <option value="">Otomatis sesuai Jenis Inventory</option>
                            @foreach($gudangs as $gudang)
                                <option value="{{ $gudang->id_gudang }}" data-kategori="{{ $gudang->kategori_gudang }}" {{ old('id_gudang', $dataInventory->id_gudang) == $gudang->id_gudang ? 'selected' : '' }}>
                                    {{ $gudang->nama_gudang }}
                    ...
                    <div class="hidden">
                        <input type="hidden" id="id_sub_kegiatan" name="id_sub_kegiatan" value="{{ old('id_sub_kegiatan', $dataInventory->id_sub_kegiatan ?? ($defaultSubKegiatanId ?? '')) }}">
                    </div>
