    ...
    <form method="POST" action="{{ route('maintenance.kalibrasi-aset.update', $kalibrasi->id_kalibrasi) }}" enctype="multipart/form-data" class="space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <label for="file_sertifikat_kamera_edit" class="inline-flex items-center px-3 py-2 border border-green-200 bg-green-100 text-green-900 text-sm font-medium rounded-md cursor-pointer hover:bg-green-100">
                    Buka Kamera
