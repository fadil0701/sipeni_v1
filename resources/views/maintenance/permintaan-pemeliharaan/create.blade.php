            ...
            <div>
                ...
                >
                    ...
                    @foreach($registerAsets as $aset)
                        <option value="{{ $aset->id_register_aset }}" {{ old('id_register_aset') == $aset->id_register_aset ? 'selected' : '' }}>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="RUTIN" {{ old('jenis_pemeliharaan') == 'RUTIN' ? 'selected' : '' }}>Rutin</option>
                        <option value="KALIBRASI" {{ old('jenis_pemeliharaan') == 'KALIBRASI' ? 'selected' : '' }}>Kalibrasi</option>
                        <option value="PERBAIKAN" {{ old('jenis_pemeliharaan') == 'PERBAIKAN' ? 'selected' : '' }}>Perbaikan</option>
                        <option value="PENGGANTIAN_SPAREPART" {{ old('jenis_pemeliharaan') == 'PENGGANTIAN_SPAREPART' ? 'selected' : '' }}>Penggantian Sparepart</option>
                    </select>
