        ...
        <div class="space-y-6">
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <div class="block w-full px-3 py-2 border border-gray-200 rounded-md bg-gray-50 text-sm text-gray-700">
                        {{ $jabatan->urutan }} (otomatis dari sistem)
                    </div>
                    <!-- <p class="mt-1 text-xs text-gray-500">Urutan tidak diubah manual dari form edit.</p> -->
                </div>

                <div class="sm:col-span-2 rounded-md border border-blue-100 bg-blue-50 px-3 py-2 text-xs text-blue-900">
                    Jabatan hanya gelar organisasi. Peran di aplikasi diatur lewat akun user pada Master Pegawai, bukan dari jabatan.
                </div>
