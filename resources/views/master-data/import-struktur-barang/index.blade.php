...
<div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6 space-y-6">
    <div class="flex flex-wrap gap-3">
        <a href="{{ route('master-data.import-struktur-barang.template') }}" class="inline-flex items-center px-4 py-2.5 rounded-md text-sm font-medium text-white bg-green-600 hover:bg-green-700 transition-colors">
