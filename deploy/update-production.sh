...
echo ""
echo "Catatan rilis: migrate mencakup bukti sampai / GPS / hasil_verifikasi."
echo "Jika UI warna lama: pastikan build frontend di atas sukses, lalu hard refresh browser."
echo ""
